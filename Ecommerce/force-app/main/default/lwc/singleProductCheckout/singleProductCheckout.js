...
export default class SingleProductCheckout extends NavigationMixin(LightningElement) {

    //checkout_single_product page API name
    //Common Varibales
    product_list = [];
    TotalCost = 0;
    isloading = false;
   
    // Variable for get url state value
    ...
    // Variable for user input handle
    ...
    currentPageReferenceHandler(currentPageReference) {
        if(currentPageReference) {
              ...
              this.product_id = currentPageReference.state.productId;
              this.product_name = currentPageReference.state.productName;
              this.product_price = currentPageReference.state.prodcutPrice;
              this.product_logo = currentPageReference.state.productLogo;
              this.product_quantity = currentPageReference.state.Quantity;

              this.TotalCost = parseInt(this.product_price) * parseInt(this.product_quantity);
    ...
    MakePayment(){
        ...
        this.product_list.push({productId:this.product_id,Quantity:this.product_quantity});
